...
public class MyAdapterTime extends RecyclerView.Adapter<MyAdapterTime.MyViewHolder> {

    ArrayList<Location> locationList;
    Context context;
    Location location;

    public MyAdapterTime(ArrayList<Location> locations, Context context) {
        this.locationList = locations;
        this.context = context;
    }

    @Override
    public MyAdapterTime.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_layout,parent,false);
        return new MyAdapterTime.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyAdapterTime.MyViewHolder holder, int position) {

        Collections.sort(locationList, Location.locationArrivalTimeComparator);
